...
background = pygame.image.load(r'C:\PP2-2025\Lab_8\AnimatedStreet.png')  #загружаем фон
...
class Enemy(pygame.sprite.Sprite): #Simple base class for visible game objects.
    def __init__(self):
        ...
        self.image = pygame.image.load(r'C:\PP2-2025\Lab_8\Enemy.png')
...
class Monet(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load(r'C:\PP2-2025\Lab_8\Monet.png')
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40,SCREEN_WIDTH-40), 0)
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load(r'C:\PP2-2025\Lab_8\Player.png')
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
          pygame.mixer.Sound(r'C:\PP2-2025\Lab_8\crash.wav').play()

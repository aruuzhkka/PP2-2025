...
background = pygame.image.load(r'C:\PP2-2025\Lab_9\AnimatedStreet.png') #загружаем фон
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load(r'C:\PP2-2025\Lab_9\Enemy.png')
...
class Monet(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load(r'C:\PP2-2025\Lab_9\Monet1.png')
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40,SCREEN_WIDTH-40), 0)
    def move(self):
        global POINT
    ...
    def reset(self):
        ...
        if (POINT+1) % 5 ==0 and POINT!=0:
            self.image = pygame.image.load(r'C:\PP2-2025\Lab_9\Monet2.png')
        else:
            self.image = pygame.image.load(r'C:\PP2-2025\Lab_9\Monet1.png')
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load(r'C:\PP2-2025\Lab_9\Player.png')
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
          pygame.mixer.Sound(r'C:\PP2-2025\Lab_9\crash.wav').play()
          time.sleep(1)

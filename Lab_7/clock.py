...
image = pygame.image.load(r'C:\PP2-2025\Lab_7\mainclock.png')
sec = pygame.image.load(r'C:\PP2-2025\Lab_7\leftarm.png')
mik_sec = sec.get_rect(center=(width, height))
minute=pygame.image.load(r'C:\PP2-2025\Lab_7\rightarm.png')
